package io.slingr.endpoints.chatgpt;
...
/**
 * ChatGPT endpoint
 * Created by pasaperez on 15/05/23.
 */
@SlingrEndpoint(name = "chatgpt", functionPrefix = "_")
public class ChatGPTEndpoint extends HttpEndpoint {
    private static final Logger logger = org.slf4j.LoggerFactory.getLogger(ChatGPTEndpoint.class);
